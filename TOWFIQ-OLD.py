...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            TOWFIQ143
\033[1;37m Facebook:           TOWFIQ HASAN
\033[1;37m Github  :            OLD-TIWFIQ
...
def cutter():
    ...
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+old+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + old )
    print("New File Saved:" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back TOWFIQ Menu ")
    SSB(allkey)       
